...
// Route to fetch stock suggestions by calling stock_suggestion.py
router.post('/stock-suggestions', async (req, res) => {
    ...
    try {
        ...
        const userData = userResponse.data.response; // Assuming it returns a string like "213333"

        // Parse userData to get necessary values (you may want to split this based on your logic)
        const responseComplexity = userData[0]; // Example: extract values based on your logic
