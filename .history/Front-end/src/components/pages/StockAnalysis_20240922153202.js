            ...
            <div className="position-fixed" style={{ top: 0, left: '300px', top: '70px', width: 'calc(100% - 300px)', backgroundColor: 'white', zIndex: 1000 }}>
                ...
                <div className="suggested-questions" style={{ marginTop: '20px' }}>
                    {suggestedQuestions.map((question, index) => (
                        <button key={index} className="suggested-question-button" onClick={() => handleSuggestedQuestionClick(question.text)} style={{ display: 'flex', alignItems: 'center', marginBottom: '10px', cursor: 'pointer' }}>
                            {question.icon}
