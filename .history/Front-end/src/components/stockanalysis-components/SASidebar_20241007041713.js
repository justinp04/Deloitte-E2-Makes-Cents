...
=======
const SASidebar = ({ favouriteStocks, addFavourite, removeFavourite, addFavouriteToDatabase, onSearch, email, onNavigate = () => { } }) => {
    const [expandedItems, setExpandedItems] = useState({}); // Tracks the open/close state of each accordion item
>>>>>>> 6203569c (Fixed Stock Summary with search by name and display full name (ticker))
