...
const StockSummary = ({ summary, references, accordionOpen, setAccordionOpen, addFavourite, removeFavourite, favouriteStocks, stockName, responseDepth, onToggleChange, email}) => {
        ...
        const fetchStockData = async () => {
            ...
            try {
                const res = await fetch('http://localhost:4000/summary/stock-summary', {
                    ...
                    body: JSON.stringify({ stockName, user_email: email, response_depth: responseDepth}), // Send the stock name to the backend
                });
