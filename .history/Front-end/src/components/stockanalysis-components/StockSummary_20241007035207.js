...
const StockSummary = ({ summary, references, accordionOpen, setAccordionOpen, addFavourite, removeFavourite, favouriteStocks, stockName, responseDepth, onToggleChange, email, setStockName}) => {
        ...
        const fetchStockData = async () => {
            ...
            try {
                ...
                if (data.company_name && data.stock_ticker) {
                    setStockName(`${data.company_name} (${data.stock_ticker})`);
                }
                console.log(data);
