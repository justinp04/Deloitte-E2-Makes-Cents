...
def main():
    ...
    user_profile = fetch_user_profile(use)
    ...
    system_message = {
        ...
        "content": (
            ...
            f"Provide personalized answers for someone who is {chatbot_experience()} {chatbot_income()} {chatbot_invest_length()} {chatbot_risk()} {chatbot_loss()} {chatbot_invest_type()}."
