...
def main():
    ...
    system_message = {
        ...
        "content": (
            ...
            f"Provide personalized answers for someone who is {chatbot_experience(user_profile)} {chatbot_income(user_profile)} {chatbot_invest_length(user_profile)} {chatbot_risk(user_profile)} {chatbot_loss()} {chatbot_invest_type()}."
