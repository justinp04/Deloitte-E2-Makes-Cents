...
def chatbot_income(user_profile):
    ...
    return experience.get(user_profile['question_response_2'], "")
...
def chatbot_invest_length(user_profile):
    ...
    return experience.get(user_profile['question_response_3'], "")
...
def chatbot_risk(user_profile):
    ...
    return experience.get(user_profile['question_response_4'], "")
...
def chatbot_loss(user_profile):
    ...
    return experience.get(user_profile['question_response_5'], "")
