...
'''''''''''''''''''''''''''''''''''''''''''''''''''
def response_complexity(user_profile):
    levels = {
    ...
    return levels.get(user_profile['question_response_1'], "")
...
def user_income(user_profile):
    ...
    return incomes.get(user_profile['question_response_2'], "")
...
def user_horizon(user_profile):
    ...
    return horizons.get(user_profile['question_response_3'], "")
...
def user_risk(user_profile):
    ...
    return risks.get(user_profile['question_response_4'], "")
...
'''''''''''''''''''''''''''''''''''''''''''''''''''
def chatbot_experience(user_profile):
    experience = {
...
PURPOSE: instructs the LLM based on user income
        for the chatbot feature
'''''''''''''''''''''''''''''''''''''''''''''''''''
def chatbot_income(user_profile):
    income = {
...
'''''''''''''''''''''''''''''''''''''''''''''''''''
def chatbot_invest_length(user_profile):
    invest_length = {
...
def chatbot_invest_type(user_profile):
    ...
    return invest_type.get(user_profile['question_response_6'], "")
