...
if __name__ == "__main__":
    # Expecting user profile data as command line arguments or input
    user_data = {
        'response_complexity': sys.argv[1],
        'user_income': sys.argv[2],
        'user_horizon': sys.argv[3],
        'user_risk': sys.argv[4],
        'user_loss': sys.argv[5],
        'user_preference': sys.argv[6]
    }
    main(user_data)