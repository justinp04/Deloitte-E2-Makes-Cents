...
def format_detailed_summary(detailed_answer):
    ...
    - Bold certain section headers (e.g., 'Growth Potential', 'Higher Volatility', 'Stability').
    """
    ...
    # Bold the key section headers using ** around them (Markdown-style for bold)
    sections_to_bold = ['Growth Potential', 'Higher Volatility', 'Stability']
    for section in sections_to_bold:
        formatted_summary = re.sub(f'({section})', r'**\1**', formatted_summary)
