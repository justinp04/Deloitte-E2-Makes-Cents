...
function UserQuestionaire() {
    ...
    return (
        <div id="questionnaire-container" className='container questionnaire-width'>
            <div className="mb-4">
                <h1 className="text-center mb-2 page-title fw-bold">REGISTER</h1>
            ...
            <hr/>
            <div className="d-flex flex-column justify-content-center align-items-cente mb-3" style={{ minHeight: '7vh' }}>
                <ProfileInsightsForm />
